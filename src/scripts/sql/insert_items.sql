...
INSERT INTO invoice (car_id, username, description, price, created_at, modified_at, starts_at, expires_at, status)
VALUES (2, 'somebody', 'third order', 300.00, curdate(), curdate(), '2017-02-21', '2017-02-25', 4);
#with debt and many-to-one relations
INSERT INTO invoice (car_id, username, description, price, created_at, modified_at, starts_at, expires_at, status)
VALUES (2, 'somebody', 'Repair car order', 100.00, curdate(), curdate(), '2017-02-25', '2018-02-25', 5);
